...
(17, 'Other', 'Home', '', 1, 0, 'http://vasantham.zeroappz.com'),
(18, 'Other', 'Pages', '', 2, 0, '#'),
...
INSERT INTO `partner` (`id`, `name`, `url`, `photo`) VALUES
(1, 'Chief Ministers Comprehensive Health Insurance Scheme', 'https://www.cmchistn.com',  ''),
(2, 'TNNHIS MidInida Health Service', 'http://www.tnnhis2016.com', ''),
(3, 'Rashtriya Swasthya Bima Yojana', 'http://www.rsby.gov.in/how_works.html', ''),
(4, 'Employee State Insurance Act', 'https://www.esic.nic.in', ''),
