...
<head>
<meta charset="utf-8">
<title>Medicoz | Health and Medical HTML Template | Blog Post Image</title>
        ...
        <div class="header-lower">
            <div class="auto-container">    
                ...
                <div class="main-box">
                    ...
                    <div class="logo-box">
                        <div class="logo"><a href="index-2.html"><img src="images/logo-9.png" alt="" title=""></a></div>
                    </div>
                        ...
                        <nav class="nav main-menu">
                            <ul class="navigation" id="navbar">
                                <li class="dropdown">
                                    <span>Home</span>
                                    <ul>
                                        <li><a href="index-2.html">Home Medical</a></li>
                                        <li><a href="index-3.html">Home Clanic</a></li>
                                        <li><a href="index-4.html">Home Dental Care</a></li>
                                        <li><a href="index-5.html">Home Eye Care</a></li>
                                        <li><a href="index-6.html">Home Prenatal care</a></li>
                                    </ul>
                                </li>
                                ...
                                <li class="current dropdown">
                                    ...
                                    <ul>
                                        ...
                                        <li class="current dropdown">
                                            <span class="current">Post Types</span>
                                            <ul>
                                                <li class="current"><a href="blog-post-image.html">Image Post</a></li>
            ...
            <div class="row clearfix">
                ...
                <div class="content-side col-lg-8 col-md-12 col-sm-12">
                    ...
                    <div class="comment-form">
                        ...
                        <form method="post" action="http://ary-themes.com/html/bold_touch/medicoz/blog.html"> 
                            <div class="row clearfix">
                ...
                <div class="sidebar-side col-lg-4 col-md-12 col-sm-12">
                    <aside class="sidebar">
                        ...
                        <div class="sidebar-widget newslatters">
                            ...
                            <form method="post" action="http://ary-themes.com/html/bold_touch/medicoz/blog-sidebar.html">
                                <div class="form-group">
