...
if(isset($_POST['form1'])) {
    ...
    if($valid == 1) {
		...
		$statement = $pdo->prepare("SHOW TABLE STATUS LIKE 'category'");
		$statement->execute();
		...
		$statement = $pdo->prepare("INSERT INTO category (category_name,category_slug,meta_title,meta_keyword,meta_description) VALUES (?,?,?,?,?)");
