...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['designation_name'])) {
    	...
    	$statement = $pdo->prepare("SELECT * FROM designation WHERE designation_name=?");
    ...
    if($valid == 1) {
		...
		// Saving data into the main table designation
		$statement = $pdo->prepare("INSERT INTO designation (designation_name) VALUES (?)");
		$statement->execute(array($_POST['designation_name']));
